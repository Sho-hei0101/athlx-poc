...
export default function MyPage() {
  const { state, getPortfolio, resetDemoData } = useStore();
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            ...
            <button
              ...
              className="self-start md:self-auto px-4 py-2 text-sm bg-slate-700 hover:bg-slate-600 rounded-lg font-semibold transition"
            >
              {t.resetDemoData}
            </button>
          </div>
