...
export const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    totalFeesCollectedLabel: 'Total fees collected (Operations 3%)',
    totalFeesCollectedNote: 'Local demo total based on this browser’s trade history.',
  ...
  ES: {
    ...
    totalFeesCollectedLabel: 'Total de comisiones recaudadas (Operaciones 3%)',
    totalFeesCollectedNote: 'Total local de demo basado en el historial de operaciones de este navegador.',
