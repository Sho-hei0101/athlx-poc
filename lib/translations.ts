export const translations = {
  EN: {
    ...
    quantity: 'Quantity',
    unitsLabel: 'units',
    unitCostLabel: 'Unit Cost (Demo Credits)',
    unitCostShort: 'Unit Cost',
  ...
  ES: {
    ...
    quantity: 'Cantidad',
    unitsLabel: 'unidades',
    unitCostLabel: 'Costo por Unidad (Créditos Demo)',
    unitCostShort: 'Costo por Unidad',
    avgUnitCost: 'Costo Promedio por Unidad',
    currentUnitCost: 'Costo Actual por Unidad',
